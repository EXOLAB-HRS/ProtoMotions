"""Prepared V5: V4 with stronger steering-task credit.
...
motion data, command distribution, reward kernel, network, and optimizer remain
unchanged.  Submit only if V4's dense sweep shows inadequate speed response.
"""
