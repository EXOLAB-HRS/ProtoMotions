"""b2-a7-headroll-s8-steepacc-pyaw-settle-w45: -settle with the transition term weight 0.15 -> 0.45 (taken from heading)."""
...
def env_config(robot_cfg, args):
    ...
    extra = .45 - TRANSITION_WEIGHT
    cfg.reward_components["speed_transition_tracking"].static_params["weight"] = .45
